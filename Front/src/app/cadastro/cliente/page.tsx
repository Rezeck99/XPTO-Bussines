"use client";
import { registerCliente } from "@/app/axios/requests";
import ButtonForm from "@/app/components/ButtonForm";
import InputForm from "@/app/components/InputForm";
import { formatarCPFeCNPJ } from "@/app/functions/formatCNPJECPF";
...
function Page() {
  ...
  useEffect(() => {
    ...
    if (cnpj) {
      setValue("cnpj", formatarCPFeCNPJ(cnpj));
    }
  }, [watch("cnpj")]);
  return (
    <form
    ...
    >
      ...
      <h1 className="text-2xl font-bold text-center">Cliente</h1>
      <InputForm title="Nome" type="text" register={register("Nome")} />
      <InputForm title="CNPJ/CPF" type="text" register={register("cnpj")} />
